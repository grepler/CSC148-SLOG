class LinkedListNode:
    ...
    def __eq__(self, other):
        ...
        True
        """
        if all([isinstance(self, LinkedListNode),
               isinstance(other, LinkedListNode)]):
            if all([self.next_ == other.next_,
...
class LinkedList:
    ...
    def __eq__(self, other):
        ...
        if str(self) == str(other) and \
                isinstance(self, LinkedList) and \
...
#                index += 1
    ...
    def __add__(self, other):
        ...
        5 -> 7 ->|
        """
        result_list = self.copy()

        current_node = other.front
        for step in range(other.size):
    ...
    def copy(self):
        ...
        current_node = self.front
        # since size is equal to the number of items in the list, inclusive
